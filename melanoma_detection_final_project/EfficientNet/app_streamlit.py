...
def main():
    ...
    **How to Use:**
    1. **Capture a Close-Up Photo:** Take a clear, close-up image of the suspicious skin spot. Ensure that the spot is well-focused and visible within the frame. **(It is recommended to edit the image before uploading it so that it focuses on the mole itself.)**
