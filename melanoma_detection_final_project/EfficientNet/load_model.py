...
model_path = "https://github.com/ShohamBirman/Projects/blob/main/melanoma_detection_final_project/EfficientNet/melanoma_classifier_weights_EfficientNet.pth"
